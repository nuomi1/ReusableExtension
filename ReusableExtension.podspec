Pod::Spec.new do |s|
  ...
  s.subspec "G3GridView" do |ss|
    ...
    ss.source_files = source_files_prefix + "G3GridView+Reusable.swift"
  end

  s.subspec "HJDanmaku" do |ss|
    ss.dependency "HJDanmaku"
    ss.source_files = source_files_prefix + "HJDanmaku+Reusable.swift"
  end

  s.subspec "RxCocoa" do |ss|
    ss.dependency "RxCocoa"
    ss.source_files = source_files_prefix + "RxCocoa+Reusable.swift"
  end

  s.subspec "SpreadsheetView" do |ss|
    ss.dependency "SpreadsheetView"
    ss.source_files = source_files_prefix + "SpreadsheetView+Reusable.swift"
  end

  s.subspec "VerticalCardSwiper" do |ss|
    ss.dependency "VerticalCardSwiper"
    ss.source_files = source_files_prefix + "VerticalCardSwiper+Reusable.swift"
  end
end
